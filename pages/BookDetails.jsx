...
export function BookDetails() {
    ...
    function onRemoveReview(reviewId) {
        bookService.removeReview(reviewId, params.bookId)
            .then(() => {
    ...
    return <div className="book-details full">

        <section className="actions">
            <Link to={`/book/${book.prevBookId}`}><button className="fa fa-prev action"></button></Link>
            <Link to={`/book/${book.nextBookId}`}><button className="fa fa-next action"></button></Link>
            <Link to="/book"><button className="fa fa-close action"></button></Link>
        </section>
        <article>
            ...
            <div>
                ...
                <p>{getReadingLevel()},{`(${book.pageCount} pages)`}</p>
                <p>{book.listPrice.amount}<span>{book.listPrice.currencyCode}</span></p>
